...
class TradesClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> models.ClientsTradesGetResponse:
        """
        Get client trades

        Retrieve trade information for a client

        GET /clients/{clientId}/trades
        ...
        Examples:
        ```py
        client.clients.trades.get(client_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/clients/{client_id}/trades",
            auth_names=["clientCredentials"],
            query_params=_query,
            cast_to=models.ClientsTradesGetResponse,
...
class AsyncTradesClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.clients.trades.get(
