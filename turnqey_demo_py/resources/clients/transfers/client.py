...
class TransfersClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> models.ClientsTransfersGetResponse:
        """
        ...
        Examples:
        ```py
        client.clients.transfers.get(client_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/clients/{client_id}/transfers",
            auth_names=["clientCredentials"],
            query_params=_query,
            cast_to=models.ClientsTransfersGetResponse,
...
class AsyncTransfersClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.clients.transfers.get(
